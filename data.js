window.PORTFOLIO_DATA = {
  ...
  "hero": {
    ...
    "sub": {
      "ko": "광고, 드라마, 라이브커머스, 3D — 매체를 가리지 않고 영상으로 메시지를 만듭니다.",
      "en": "Advertising, drama, live commerce, 3D — turning ideas into film across every medium."
    },
    "primaryCta": { "ko": "작업 보기", "en": "See work" },
    "secondaryCta": { "ko": "프로필 다운로드", "en": "Download profile" }
  },
  "stats": [
  ...
  "capabilitiesSection": {
    "title": { "ko": "역량", "en": "Capabilities" },
    "sub": { "ko": "한 명의 감독이 끝까지 책임지는 6가지 영역", "en": "Six disciplines, one director from start to finish" }
  },
  "capabilities": [
    {
      "id": "cap-1",
      "title": { "ko": "디렉팅 · 연출", "en": "Directing" },
      "body": { "ko": "콘셉트 빌드부터 현장 디렉팅까지. 출연자와 스태프가 가장 좋은 컨디션을 낼 수 있는 환경을 설계합니다.", "en": "From concept to set. I build the environment where the talent and crew do their best work." }
    },
    {
      "id": "cap-2",
    ...
    {
      "id": "cap-3",
      "title": { "ko": "편집 · 컬러", "en": "Edit · Color" },
      "body": { "ko": "Premiere Pro · DaVinci Resolve. 광고 호흡부터 다큐 호흡까지 톤 조율.", "en": "Premiere Pro and DaVinci Resolve, from ad‑pace cuts to documentary breath." }
    },
    {
      "id": "cap-4",
    ...
    {
      "id": "cap-5",
      "title": { "ko": "VFX · 합성", "en": "VFX · Compositing" },
      "body": { "ko": "After Effects · Nuke. '택시운전사' 로토스코핑 참여 등 영화 후반 경험.", "en": "After Effects and Nuke. Feature‑film post including rotoscoping on 'A Taxi Driver'." }
    },
    {
      "id": "cap-6",
  ...
  "workSection": {
    "title": { "ko": "작업", "en": "Selected Work" },
    "sub": { "ko": "9개 카테고리, 매체를 넘나드는 포트폴리오", "en": "Nine categories, every format" }
  },
  "categories": [
    {
      "id": "cat-ad",
  ...
  "career": {
    ...
    "items": [
      ...
      { "year": "2024.06", "title": { "ko": "리버스(Rebirth) — 제품 홍보영상", "en": "Rebirth — Product Promo" }, "body": { "ko": "리버스 브랜드 제품 홍보영상 기획·제작.", "en": "Concept and production for Rebirth product film." }, "badge": null },
      { "year": "2024.06", "title": { "ko": "안심(Ansim) 도자기 — 제품 홍보영상", "en": "Ansim Ceramics — Product Promo" }, "body": { "ko": "안심 도자기 브랜드 홍보영상 제작.", "en": "Brand film for Ansim Ceramics." }, "badge": null },
      { "year": "2023.11", "title": { "ko": "위티미티(Wittymitty) — SNS 홍보영상", "en": "Wittymitty — Social Promo" }, "body": { "ko": "위티미티 SNS 채널 홍보영상 제작.", "en": "Social-channel promo film for Wittymitty." }, "badge": null },
      { "year": "2023.04", "title": { "ko": "스킨바이블 — 피르패드 출시 SNS 홍보영상", "en": "Skinbible — Pirpad Launch SNS Promo" }, "body": { "ko": "스킨바이블 신제품 '피르패드' 런칭 SNS 영상.", "en": "Launch SNS video for Skinbible's Pirpad release." }, "badge": null },
      { "year": "2023.04", "title": { "ko": "말랑아이디어 — 롤링핏 출시 SNS 홍보영상", "en": "Mallang Idea — Rolling Fit SNS Promo" }, "body": { "ko": "말랑아이디어 '롤링핏' 출시 SNS 홍보영상 제작.", "en": "SNS launch promo for Mallang Idea's Rolling Fit." }, "badge": null },
      { "year": "2022.12", "title": { "ko": "아리아 스튜디오 — 공간 디자인", "en": "Aria Studio — Space Design" }, "body": { "ko": "아리아 스튜디오 공간 디자인 및 설계.", "en": "Space design and planning for Aria Studio." }, "badge": { "ko": "공간", "en": "Space" } },
      { "year": "2022.11", "title": { "ko": "일품미각 — 밀키트 홍보영상", "en": "Ilpum Migak — Meal Kit Promo" }, "body": { "ko": "밀키트 브랜드 일품미각 홍보영상 제작.", "en": "Promotional film for meal-kit brand Ilpum Migak." }, "badge": null },
      { "year": "2022.07", "title": { "ko": "바라바(BARABA) — 애견용품 홍보영상", "en": "BARABA — Pet Goods Promo" }, "body": { "ko": "바라바 애견용품 브랜드 홍보영상 제작.", "en": "Pet-goods brand film for BARABA." }, "badge": null },
      { "year": "2022.06", "title": { "ko": "이고다(IGODA) — 생활용품 홍보영상", "en": "IGODA — Lifestyle Goods Promo" }, "body": { "ko": "이고다 생활용품 브랜드 홍보영상 제작.", "en": "Lifestyle-goods brand film for IGODA." }, "badge": null },
      { "year": "2022.01", "title": { "ko": "니가드키즈4 — 와디즈 펀딩 4.4억 달성", "en": "Nigaard Kids 4 — Wadiz ₩440M" }, "body": { "ko": "홍보영상 및 상세페이지 기획·제작. 와디즈 펀딩 4.4억 원 달성.", "en": "Promo film and product detail-page direction; ₩440M raised on Wadiz." }, "badge": { "ko": "₩440M", "en": "₩440M" } },
      { "year": "2021.07", "title": { "ko": "다니고(DANIGO) — 캠핑용품 홍보영상", "en": "DANIGO — Camping Goods Promo" }, "body": { "ko": "다니고 캠핑용품 브랜드 홍보영상 제작.", "en": "Camping-goods promo film for DANIGO." }, "badge": null },
      { "year": "2020.09", "title": { "ko": "VT Cosmetics — 베트남 지사 SNS 홍보영상", "en": "VT Cosmetics — Vietnam SNS Promo" }, "body": { "ko": "VT Cosmetics 베트남 지사 SNS 홍보영상 제작.", "en": "SNS promo film for VT Cosmetics' Vietnam office." }, "badge": { "ko": "글로벌", "en": "Global" } },
      { "year": "2020.08", "title": { "ko": "차모아(CHAMOA) 클로버 멀티컵홀더 — 와디즈 펀딩 3.8억", "en": "CHAMOA Clover Multi Cup Holder — Wadiz ₩380M" }, "body": { "ko": "기획·제작 디렉팅. 와디즈 펀딩 3.8억 원 달성.", "en": "Concept and production direction; ₩380M raised on Wadiz." }, "badge": { "ko": "₩380M", "en": "₩380M" } },
      { "year": "2020.06", "title": { "ko": "대한민국 국방부 — 6·25 전쟁 70주년 기념 영상", "en": "ROK Ministry of National Defense — Korean War 70th Anniversary Film" }, "body": { "ko": "국방부 6·25 전쟁 70주년 기념 영상 제작. 수상.", "en": "70th-anniversary commemorative film for the Ministry of National Defense. Award-winning." }, "badge": { "ko": "수상작", "en": "Award" } },
      { "year": "2019.04", "title": { "ko": "주식회사 씨에스엔 — 커큐민 홍보영상", "en": "CSN Inc. — Curcumin Promo" }, "body": { "ko": "CSN 커큐민 제품 홍보영상 제작.", "en": "Promotional film for CSN's curcumin product." }, "badge": null },
      { "year": "2019.03", "title": { "ko": "상업영화 '공수도' — 캐스팅 디렉터", "en": "Feature 'Gongsudo' — Casting Director" }, "body": { "ko": "상업영화 '공수도' 캐스팅 디렉터로 참여.", "en": "Casting director on the feature 'Gongsudo'." }, "badge": { "ko": "장편 영화", "en": "Feature" } },
      { "year": "2018.04", "title": { "ko": "본스타컴퍼니 — 콘텐츠 프로듀서 / 캐스팅 디렉터", "en": "Bornstar Company — Content Producer / Casting Director" }, "body": { "ko": "엔터테인먼트 콘텐츠 프로듀싱 및 캐스팅 디렉팅.", "en": "Producing entertainment content and directing casting." }, "badge": null },
      { "year": "2017.06", "title": { "ko": "상업영화 '택시운전사' — 로토스코핑", "en": "Feature 'A Taxi Driver' — Rotoscoping" }, "body": { "ko": "장훈 감독, 송강호 주연 '택시운전사' 후반 로토스코핑 작업.", "en": "Rotoscoping post-production on the Jang Hoon feature starring Song Kang-ho." }, "badge": { "ko": "장편 영화", "en": "Feature" } },
      { "year": "2017.06", "title": { "ko": "훼밀리씨앤디 — 부광여고 내진설계 도면 수정", "en": "Family C&D — Bugwang Girls' HS Seismic Drawings" }, "body": { "ko": "부광여고 내진설계 공사 현장 도면 수정 작업.", "en": "On-site drawing revisions for Bugwang Girls' High School seismic retrofit." }, "badge": null },
      { "year": "2017.02", "title": { "ko": "노바빈 — Jam2go 'Creator Talk'", "en": "Novabin — Jam2go 'Creator Talk'" }, "body": { "ko": "노바빈 Jam2go 'Creator Talk' 콘텐츠 제작.", "en": "Content production for Novabin's Jam2go 'Creator Talk'." }, "badge": null },
      { "year": "2015.12", "title": { "ko": "겸재정선미술관 — 미디어 3D 아트 전시", "en": "Gyeomjae Jeong Seon Museum — Media 3D Art Exhibit" }, "body": { "ko": "겸재정선미술관 미디어 3D 아트 전시 참여.", "en": "Participated in a media 3D art exhibition at the Gyeomjae Jeong Seon Museum." }, "badge": { "ko": "전시", "en": "Exhibit" } },
      { "year": "2014.11", "title": { "ko": "한국공간디자인협회 공모전 — 특별상", "en": "Korea Spatial Design Awards — Special Prize" }, "body": { "ko": "한국공간디자인 공모전 특별상 수상.", "en": "Special Prize at the Korea Spatial Design Awards." }, "badge": { "ko": "특별상", "en": "Special" } },
      { "year": "2014.11", "title": { "ko": "광주디자인센터 — 'The Giving Tree' 전시", "en": "Gwangju Design Center — 'The Giving Tree' Exhibit" }, "body": { "ko": "실내디자인 'The Giving Tree' 전시 참여.", "en": "Interior-design exhibit 'The Giving Tree'." }, "badge": { "ko": "전시", "en": "Exhibit" } }
    ]
  },
  "contact": {
    "title": { "ko": "함께 만들어요", "en": "Let's make something" },
    "sub": { "ko": "프로젝트 문의는 메일로 보내주세요. 24시간 안에 회신드립니다.", "en": "For projects, drop me an email. Reply within 24h." },
    "cta": { "ko": "메일 보내기", "en": "Send email" }
  },
  "theme": {
    "accent": "#0071e3",
    "radius": 18,
